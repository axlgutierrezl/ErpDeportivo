...
<template>
  ...
  <v-app>
      ...
      <div class="pa-4 pl-1">
        <div class="logo">
          <a href="/" class="router-link-active d-flex">
            <img
              src="https://adminpro-vuetify-dark.netlify.app/assets/white-logo-icon.6bfee9b1.svg"
            />
            <img
              src="https://adminpro-vuetify-dark.netlify.app/assets/white-logo-text.7766c51f.svg"
              class="pl-3"
            />
          </a>
        </div>
    ...
    <v-navigation-drawer
      :permanent="permanent"
      v-model="rail"
      :rail="permanent ? drawer : false"
      expand-on-hover
    >
      <v-list>
        <v-list-item
          :prepend-avatar="$page.props.user.profile_photo_url"
